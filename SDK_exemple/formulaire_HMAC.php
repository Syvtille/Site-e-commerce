...
$pbx_souhaitauthent = '1';		//variable de test authentification 3DS (1 par défaut, 2 pour exemption 3DS)
if ($pbx_total>3000) {$pbx_souhaitauthent = '1';}	//variable de test pour s'assurer que l'exemption 3DS n'est pas proposée sur une transaction supérieur à 30€
